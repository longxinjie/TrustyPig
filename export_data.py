...
def export_data():
    ...
    cred = credentials.Certificate("../smu-fintech-mvp-2025-firebase-adminsdk-fbsvc-f9c8e62f9b.json")
    ...
    df.to_csv("data/app_transactions.csv", index=False)  # 👈 here it’s created
